...
m.reply(`Exif berhasil diubah menjadi\n\nΩ Packname : ${global.packname}\nΩ Author : ${global.author}`)
}
break
case 'kick': {
if (!m.isGroup) throw mess.group
...
teks += `Ω @${i.userJid.split('@')[0]}\n`
teks += ` ┗━Ω *Waktu :* ${moment(waktu * 1000).format('DD/MM/YY HH:mm:ss')} Ω *Status :* ${read ? 'Dibaca' : 'Terkirim'}\n\n`
}
...
teks += `Ω No : ${no++}\nΩ Type : ${i.type}\nΩ Video ID : ${i.videoId}\nΩ Title : ${i.title}\nΩ Views : ${i.views}\nΩ Duration : ${i.timestamp}\nΩ Upload At : ${i.ago}\nΩ Author : ${i.author.name}\nΩ Url : ${i.url}\n\n─────────────────\n\n`
}
...
for (let g of res) {
teks += `Ω *Title* : ${g.title}\n`
teks += `Ω *Description* : ${g.snippet}\n`
teks += `Ω *Link* : ${g.link}\n\n────────────────────────\n\n`
} 
m.reply(teks)
})
...
Ω Ext : Search
Ω Id : ${anu.videoId}
Ω Duration : ${anu.timestamp}
Ω Viewers : ${anu.views}
Ω Upload At : ${anu.ago}
Ω Author : ${anu.author.name}
Ω Channel : ${anu.author.url}
Ω Description : ${anu.description}
Ω Url : ${anu.url}`,
footer: hisoka.user.name,
buttons: buttons,
headerType: 4
...
hisoka.sendImage(m.chat, media.thumb, `Ω Title : ${media.title}\nΩ File Size : ${media.filesizeF}\nΩ Url : ${isUrl(text)}\nΩ Ext : MP3\nΩ Resolusi : ${args[1] || '128kbps'}`, m)
...
if (media.filesize >= 100000) return m.reply('File Melebihi Batas '+util.format(media))
hisoka.sendMessage(m.chat, { video: { url: media.dl_link }, mimetype: 'video/mp4', fileName: `${media.title}.mp4`, caption: `Ω Title : ${media.title}\nΩ File Size : ${media.filesizeF}\nΩ Url : ${isUrl(text)}\nΩ Ext : MP3\nΩ Resolusi : ${args[1] || '360p'}` }, { quoted: m })
}
break
case 'getmusic': {
let { yta } = require('./lib/y2mate')
...
break
		...
		let { pinterest } = require('./lib/scraper')
                ...
                hisoka.sendMessage(m.chat, { image: { url: result }, caption: 'Ω Media Url : '+result }, { quoted: m })
            }
            break
case 'couple': {
m.reply(mess.wait)
...
{buttonId: `coffe`, buttonText: {displayText: 'Next Image'}, type: 1}
		...
		let buttons = [
                ...
                let buttonMessage = {
                    ...
                    caption: `Ω Title : ${result.title}\nΩ Category : ${result.type}\nΩ Detail : ${result.source}\nΩ Media Url : ${result.image[2] || result.image[1] || result.image[0]}`,
                    footer: hisoka.user.name,
                    buttons: buttons,
                    headerType: 4
                }
		...
		let { wikimedia } = require('./lib/scraper')
                ...
                let buttonMessage = {
                    ...
                    caption: `Ω Title : ${result.title}\nΩ Source : ${result.source}\nΩ Media Url : ${result.image}`,
                    footer: hisoka.user.name,
                    buttons: buttons,
                    headerType: 4
                }
	    ...
	    case 'nomerhoki': case 'nomorhoki': {
            ...
            case 'artimimpi': case 'tafsirmimpi': {
                ...
                if (anu.status == false) return m.reply(anu.message)
                hisoka.sendText(m.chat, `Ω *Mimpi :* ${anu.message.mimpi}\nΩ *Arti :* ${anu.message.arti}\nΩ *Solusi :* ${anu.message.solusi}`, m)
            }
            break
            case 'ramalanjodoh': case 'ramaljodoh': {
                ...
                if (anu.status == false) return m.reply(anu.message)
                hisoka.sendText(m.chat, `Ω *Nama Anda :* ${anu.message.nama_anda.nama}\nΩ *Lahir Anda :* ${anu.message.nama_anda.tgl_lahir}\nΩ *Nama Pasangan :* ${anu.message.nama_pasangan.nama}\nΩ *Lahir Pasangan :* ${anu.message.nama_pasangan.tgl_lahir}\nΩ *Hasil :* ${anu.message.result}\nΩ *Catatan :* ${anu.message.catatan}`, m)
            }
            break
            ...
            case 'suamiistri': {
                ...
                if (anu.status == false) return m.reply(anu.message)
                hisoka.sendText(m.chat, `Ω *Nama Suami :* ${anu.message.suami.nama}\nΩ *Lahir Suami :* ${anu.message.suami.tgl_lahir}\nΩ *Nama Istri :* ${anu.message.istri.nama}\nΩ *Lahir Istri :* ${anu.message.istri.tgl_lahir}\nΩ *Hasil :* ${anu.message.result}\nΩ *Catatan :* ${anu.message.catatan}`, m)
            }
            break
            case 'ramalancinta': case 'ramalcinta': {
                ...
                if (anu.status == false) return m.reply(anu.message)
                hisoka.sendText(m.chat, `Ω *Nama Anda :* ${anu.message.nama_anda.nama}\nΩ *Lahir Anda :* ${anu.message.nama_anda.tgl_lahir}\nΩ *Nama Pasangan :* ${anu.message.nama_pasangan.nama}\nΩ *Lahir Pasangan :* ${anu.message.nama_pasangan.tgl_lahir}\nΩ *Sisi Positif :* ${anu.message.sisi_positif}\nΩ *Sisi Negatif :* ${anu.message.sisi_negatif}\nΩ *Catatan :* ${anu.message.catatan}`, m)
            }
            break
            case 'artinama': {
                ...
                if (anu.status == false) return m.reply(anu.message)
                hisoka.sendText(m.chat, `Ω *Nama :* ${anu.message.nama}\nΩ *Arti :* ${anu.message.arti}\nΩ *Catatan :* ${anu.message.catatan}`, m)
            }
            break
            case 'kecocokannama': case 'cocoknama': {
                ...
                if (anu.status == false) return m.reply(anu.message)
                hisoka.sendText(m.chat, `Ω *Nama :* ${anu.message.nama}\nΩ *Lahir :* ${anu.message.tgl_lahir}\nΩ *Life Path :* ${anu.message.life_path}\nΩ *Destiny :* ${anu.message.destiny}\nΩ *Destiny Desire :* ${anu.message.destiny_desire}\nΩ *Personality :* ${anu.message.personality}\nΩ *Persentase :* ${anu.message.persentase_kecocokan}`, m)
            }
            break
            case 'kecocokanpasangan': case 'cocokpasangan': case 'pasangan': {
                ...
                if (anu.status == false) return m.reply(anu.message)
                hisoka.sendImage(m.chat,  anu.message.gambar, `Ω *Nama Anda :* ${anu.message.nama_anda}\nΩ *Nama Pasangan :* ${anu.message.nama_pasangan}\nΩ *Sisi Positif :* ${anu.message.sisi_positif}\nΩ *Sisi Negatif :* ${anu.message.sisi_negatif}`, m)
            }
            break
            case 'jadianpernikahan': case 'jadiannikah': {
                ...
                if (anu.status == false) return m.reply(anu.message)
                hisoka.sendText(m.chat, `Ω *Tanggal Pernikahan :* ${anu.message.tanggal}\nΩ *karakteristik :* ${anu.message.karakteristik}`, m)
            }
            break
            case 'sifatusaha': {
                ...
                if (anu.status == false) return m.reply(anu.message)
                hisoka.sendText(m.chat, `Ω *Lahir :* ${anu.message.hari_lahir}\nΩ *Usaha :* ${anu.message.usaha}`, m)
            }
            break
            ...
            case 'pekerjaan': case 'kerja': {
                ...
                if (anu.status == false) return m.reply(anu.message)
                hisoka.sendText(m.chat, `Ω *Lahir :* ${anu.message.hari_lahir}\nΩ *Pekerjaan :* ${anu.message.pekerjaan}\nΩ *Catatan :* ${anu.message.catatan}`, m)
            }
            break
            case 'ramalannasib': case 'ramalnasib': case 'nasib': {
                ...
                if (anu.status == false) return m.reply(anu.message)
                hisoka.sendText(m.chat, `Ω *Analisa :* ${anu.message.analisa}\nΩ *Angka Akar :* ${anu.message.angka_akar}\nΩ *Sifat :* ${anu.message.sifat}\nΩ *Elemen :* ${anu.message.elemen}\nΩ *Angka Keberuntungan :* ${anu.message.angka_keberuntungan}`, m)
            }
            break
            ...
            case 'artitarot': case 'tarot': {
                ...
                if (anu.status == false) return m.reply(anu.message)
                hisoka.sendImage(m.chat, anu.message.image, `Ω *Lahir :* ${anu.message.tgl_lahir}\nΩ *Simbol Tarot :* ${anu.message.simbol_tarot}\nΩ *Arti :* ${anu.message.arti}\nΩ *Catatan :* ${anu.message.catatan}`, m)
            }
            break
            case 'fengshui': {
                ...
                if (anu.status == false) return m.reply(anu.message)
                hisoka.sendText(m.chat, `Ω *Nama :* ${anu.message.nama}\nΩ *Lahir :* ${anu.message.tahun_lahir}\nΩ *Gender :* ${anu.message.jenis_kelamin}\nΩ *Angka Kua :* ${anu.message.angka_kua}\nΩ *Kelompok :* ${anu.message.kelompok}\nΩ *Karakter :* ${anu.message.karakter}\nΩ *Sektor Baik :* ${anu.message.sektor_baik}\nΩ *Sektor Buruk :* ${anu.message.sektor_buruk}`, m)
            }
            break
            case 'haribaik': {
                if (!text) throw `Example : ${prefix + command} 7, 7, 2005`
                ...
                if (anu.status == false) return m.reply(anu.message)
                hisoka.sendText(m.chat, `Ω *Lahir :* ${anu.message.tgl_lahir}\nΩ *Kala Tinantang :* ${anu.message.kala_tinantang}\nΩ *Info :* ${anu.message.info}\nΩ *Catatan :* ${anu.message.catatan}`, m)
            }
            break
            ...
            case 'harinaas': case 'harisial': {
                ...
                if (anu.status == false) return m.reply(anu.message)
                hisoka.sendText(m.chat, `Ω *Hari Lahir :* ${anu.message.hari_lahir}\nΩ *Tanggal Lahir :* ${anu.message.tgl_lahir}\nΩ *Hari Naas :* ${anu.message.hari_naas}\nΩ *Info :* ${anu.message.catatan}\nΩ *Catatan :* ${anu.message.info}`, m)
            }
            break
            case 'nagahari': case 'harinaga': {
                ...
                if (anu.status == false) return m.reply(anu.message)
                hisoka.sendText(m.chat, `Ω *Hari Lahir :* ${anu.message.hari_lahir}\nΩ *Tanggal Lahir :* ${anu.message.tgl_lahir}\nΩ *Arah Naga Hari :* ${anu.message.arah_naga_hari}\nΩ *Catatan :* ${anu.message.catatan}`, m)
            }
            break
            case 'arahrejeki': case 'arahrezeki': {
                ...
                if (anu.status == false) return m.reply(anu.message)
                hisoka.sendText(m.chat, `Ω *Hari Lahir :* ${anu.message.hari_lahir}\nΩ *tanggal Lahir :* ${anu.message.tgl_lahir}\nΩ *Arah Rezeki :* ${anu.message.arah_rejeki}\nΩ *Catatan :* ${anu.message.catatan}`, m)
            }
            break
            case 'peruntungan': {
                ...
                if (anu.status == false) return m.reply(anu.message)
                hisoka.sendText(m.chat, `Ω *Nama :* ${anu.message.nama}\nΩ *Lahir :* ${anu.message.tgl_lahir}\nΩ *Peruntungan Tahun :* ${anu.message.peruntungan_tahun}\nΩ *Hasil :* ${anu.message.result}\nΩ *Catatan :* ${anu.message.catatan}`, m)
            }
            break
            case 'weton': case 'wetonjawa': {
                ...
                if (anu.status == false) return m.reply(anu.message)
                hisoka.sendText(m.chat, `Ω *Tanggal :* ${anu.message.tanggal}\nΩ *Jumlah Neptu :* ${anu.message.jumlah_neptu}\nΩ *Watak Hari :* ${anu.message.watak_hari}\nΩ *Naga Hari :* ${anu.message.naga_hari}\nΩ *Jam Baik :* ${anu.message.jam_baik}\nΩ *Watak Kelahiran :* ${anu.message.watak_kelahiran}`, m)
            }
            break
            case 'sifat': case 'karakter': {
                ...
                if (anu.status == false) return m.reply(anu.message)
                hisoka.sendText(m.chat, `Ω *Nama :* ${anu.message.nama}\nΩ *Lahir :* ${anu.message.tgl_lahir}\nΩ *Garis Hidup :* ${anu.message.garis_hidup}`, m)
            }
            break
            case 'keberuntungan': {
                if (!text) throw `Example : ${prefix + command} Dika, 7, 7, 2005`
            ...
            case 'memancing': {
                ...
                if (anu.status == false) return m.reply(anu.message)
                hisoka.sendText(m.chat, `Ω *Tanggal :* ${anu.message.tgl_memancing}\nΩ *Hasil :* ${anu.message.result}\nΩ *Catatan :* ${anu.message.catatan}`, m)
            }
            break
            case 'masasubur': {
                ...
                if (anu.status == false) return m.reply(anu.message)
                hisoka.sendText(m.chat, `Ω *Hasil :* ${anu.message.result}\nΩ *Catatan :* ${anu.message.catatan}`, m)
            }
            break
            case 'zodiak': case 'zodiac': {
                ...
                if (anu.status == false) return m.reply(anu.message)
                hisoka.sendText(m.chat, `Ω *Zodiak :* ${anu.message.zodiak}\nΩ *Nomor :* ${anu.message.nomor_keberuntungan}\nΩ *Aroma :* ${anu.message.aroma_keberuntungan}\nΩ *Planet :* ${anu.message.planet_yang_mengitari}\nΩ *Bunga :* ${anu.message.bunga_keberuntungan}\nΩ *Warna :* ${anu.message.warna_keberuntungan}\nΩ *Batu :* ${anu.message.batu_keberuntungan}\nΩ *Elemen :* ${anu.message.elemen_keberuntungan}\nΩ *Pasangan Zodiak :* ${anu.message.pasangan_zodiak}\nΩ *Catatan :* ${anu.message.catatan}`, m)
            }
            break
            case 'shio': {
                ...
                if (anu.status == false) return m.reply(anu.message)
                hisoka.sendText(m.chat, `Ω *Hasil :* ${anu.message}`, m)
            }
            break
		...
		if (!isPremium && global.db.data.users[m.sender].limit < 1) return m.reply('Limit Harian Anda Telah Habis')
		    ...
		    db.data.users[m.sender].limit -= 1
                    ...
                    if (anu.status == false) return m.reply(anu.result.message)
                    hisoka.sendMedia(m.chat, anu.caption.profile_hd, '', `Ω Full Name : ${anu.caption.full_name}\nΩ User Name : ${anu.caption.user_name}\nΩ ID ${anu.caption.user_id}\nΩ Followers : ${anu.caption.followers}\nΩ Following : ${anu.caption.following}\nΩ Bussines : ${anu.caption.bussines}\nΩ Profesional : ${anu.caption.profesional}\nΩ Verified : ${anu.caption.verified}\nΩ Private : ${anu.caption.private}\nΩ Bio : ${anu.caption.biography}\nΩ Bio Url : ${anu.caption.bio_url}`, m)
		    db.data.users[m.sender].limit -= 1
                } else if (type.toLowerCase() == 'npm') {
                    if (!id) throw `No Query username, Example : ${prefix + command} npm scrape-primbon`
                    let { result: anu } = await fetchJson(api('zenz', '/api/stalker/npm', { query: id }, '9d30efca66'))
                    if (anu.status == false) return m.reply(anu.result.message)
                    m.reply(`Ω Name : ${anu.name}\nΩ Version : ${Object.keys(anu.versions)}\nΩ Created : ${tanggal(anu.time.created)}\nΩ Modified : ${tanggal(anu.time.modified)}\nΩ Maintainers :\n ${anu.maintainers.map(v => `- ${v.name} : ${v.email}`).join('\n')}\n\nΩ Description : ${anu.description}\nΩ Homepage : ${anu.homepage}\nΩ Keywords : ${anu.keywords}\nΩ Author : ${anu.author.name}\nΩ License : ${anu.license}\nΩ Readme : ${anu.readme}`)
		    db.data.users[m.sender].limit -= 1
                } else {
            ...
            case 'joox': case 'jooxdl': {
                ...
                let msg = await hisoka.sendImage(m.chat, anu.result.img, `Ω Title : ${anu.result.lagu}\nΩ Album : ${anu.result.album}\nΩ Singer : ${anu.result.penyanyi}\nΩ Publish : ${anu.result.publish}\nΩ Lirik :\n${anu.result.lirik.result}`, m)
            ...
            case 'soundcloud': case 'scdl': {
                ...
                let msg = await hisoka.sendImage(m.chat, anu.result.thumb, `Ω Title : ${anu.result.title}\nΩ Url : ${isUrl(text)[0]}`)
	        ...
	        case 'fbdl': case 'fb': case 'facebook': {
                ...
                hisoka.sendMessage(m.chat, { video: { url: anu.result.url }, caption: `Ω Title : ${anu.result.title}`}, { quoted: m })
            }
            break
...
`,
		    ...
		    anu.media.map(async (url) => {
		        hisoka.sendMessage(m.chat, { image: { url }, caption: `Ω Title : ${anu.title}\nΩ Author : ${anu.author.name}\nΩ Like : ${anu.like}\nΩ Caption : ${anu.caption}` }, { quoted: m })
		    })
		}
	    }
	    break
...
let capt = `Ω Anibatch Search From ${text}\n\n`
for (let i of res.result){
capt += `Ω Title : ${i.title}\n`                              
capt += `Ω Url : ${i.url}\n`           
capt += `Ω Thumbnail : ${i.thumbnail}\n`           
capt += `Ω Rate : ${i.rate}\n\n──────────────────────\n`
}
...
let teks = `Ω Anime Planet Search From ${text}\n\n`
for (let i of res.result) {
teks += `Ω Title : ${i.title}\n`                              
teks += `Ω Url : ${i.url}\n`           
teks += `Ω Thumbnail : ${i.thumbnail}\n\n──────────────────────\n`
}
m.reply(teks)
}
break  
...
let capt = `Ω AniSearch From ${text}\n\n`
for (let i of res.result){
capt += `Ω Title : ${i.title}\n`                              
capt += `Ω Url : ${i.url}\n`           
capt += `Ω Thumbnail : ${i.thumbnail}\n`     
capt += `Ω Genre : ${i.genres}\n\n──────────────────────\n`
}
hisoka.sendImage(m.chat, res.result[0].thumbnail, capt, m)
}
break   
...
let capt = `Ω Anoboy Search From ${text}\n\n`
for (let i of res.result){
capt += `Ω Title : ${i.title}\n`                              
capt += `Ω Url : ${i.url}\n`           
capt += `Ω Thumbnail : ${i.thumbnail}\n`           
capt += `Ω Showup : ${i.showup}\n\n──────────────────────\n`
}
hisoka.sendImage(m.chat, res.result[0].thumbnail, capt, m)
}
break     
...
let capt = `Ω Gogoanime Search From ${text}\n\n`
for (let i of res.result){
capt += `Ω Title : ${i.name}\n`                              
capt += `Ω Url : ${i.url}\n`           
capt += `Ω Thumbnail : ${i.thumbnail}\n`           
capt += `Ω Released : ${i.released}\n\n──────────────────────\n`
}
hisoka.sendImage(m.chat, res.result[0].thumbnail, capt, m)
}
break     
...
let capt = `Ω Jouganime Search From ${text}\n\n`
for (let i of res.result){
capt += `Ω Title : ${i.title}\n`                              
capt += `Ω Url : ${i.url}\n`           
capt += `Ω Thumbnail : ${i.thumbnail}\n`     
...
let capt = `Ω Kiryu Search From ${text}\n\n`
for (let i of res.result){
capt += `Ω Title : ${i.title}\n`                              
capt += `Ω Url : ${i.url}\n`           
capt += `Ω Thumbnail : ${i.thumbnail}\n`     
capt += `Ω Chapter : ${i.chapter}\n`                 
capt += `Ω Rate : ${i.rate}\n\n──────────────────────\n`
}
hisoka.sendImage(m.chat, res.result[0].thumbnail, capt, m)
}
...
let teks = `Ω Kiss Manga Search From ${text}\n\n`
for (let i of res.result) {
teks += `Ω Title : ${i.title}\n`                              
teks += `Ω Url : ${i.url}\n\n──────────────────────\n`
}
...
let capt = `Ω Klik Manga Search From ${text}\n\n`
for (let i of res.result){
capt += `Ω Title : ${i.title}\n`                              
capt += `Ω Url : ${i.url}\n`           
capt += `Ω Thumbnail : ${i.thumbnail}\n`     
capt += `Ω Author : ${i.author}\n`         
capt += `Ω Genre : ${i.genres}\n`                 
capt += `Ω Status : ${i.status}\n`      
capt += `Ω Date : ${i.date}\n`                                      
capt += `Ω Desc : ${i.description}\n\n──────────────────────\n`
}
hisoka.sendImage(m.chat, res.result[0].thumbnail, capt, m)
}
break   
...
let capt = `Ω Komiku Search From ${text}\n\n`
for (let i of res.result){
capt += `Ω Title : ${i.title}\n`                              
capt += `Ω Url : ${i.url}\n`           
capt += `Ω Thumbnail : ${i.thumbnail}\n`     
...
let capt = `Ω Mangadex Search From ${text}\n\n`
for (let i of res.result){
capt += `Ω Title : ${i.title}\n`                              
capt += `Ω Url : ${i.url}\n`           
capt += `Ω Thumbnail : ${i.thumbnail}\n`     
capt += `Ω Rate : ${i.rate}\n`         
capt += `Ω Followers : ${i.followers}\n`                 
capt += `Ω Views : ${i.views}\n`                                
capt += `Ω Desc : ${i.description}\n\n──────────────────────\n`
}
hisoka.sendImage(m.chat, res.result[0].thumbnail, capt, m)
}
...
let capt = `Ω Manganato Search From ${text}\n\n`
for (let i of res.result){
capt += `Ω Title : ${i.title}\n`                              
capt += `Ω Url : ${i.url}\n`           
capt += `Ω Thumbnail : ${i.thumbnail}\n`     
...
let capt = `Ω Myanimelist Search From ${text}\n\n`
for (let i of res.result){
capt += `Ω Title : ${i.title}\n`                              
capt += `Ω Url : ${i.url}\n`           
capt += `Ω Thumbnail : ${i.thumbnail}\n`     
...
let teks = `Ω Nekoanime Search From ${text}\n\n`
for (let i of res.result) {
teks += `Ω Title : ${i.title}\n`                              
teks += `Ω Url : ${i.url}\n`           
teks += `Ω Chapter : ${i.chapter}\n`           
teks += `Ω Release : ${i.released}\n\n──────────────────────\n`
}
m.reply(teks)
}
break  
...
let teks = `Ω Namigami Search From ${text}\n\n`
for (let i of res.result) {
teks += `Ω Title : ${i.title}\n`                              
teks += `Ω Url : ${i.url}\n`           
teks += `Ω Status : ${i.status}\n`           
teks += `Ω Rate : ${i.rate}\n`           
teks += `Ω Category : ${i.category}\n\n──────────────────────\n`
}
m.reply(teks)
}
break  
...
let capt = `Ω Oploverz Search From ${text}\n\n`
for (let i of res.result){
capt += `Ω Title : ${i.title}\n`                              
capt += `Ω Url : ${i.url}\n`           
capt += `Ω Thumbnail : ${i.thumbnail}\n`     
...
let capt = `Ω Samehadaku Search From ${text}\n\n`
for (let i of res.result){
capt += `Ω Title : ${i.title}\n`                              
capt += `Ω Url : ${i.url}\n`           
capt += `Ω Thumbnail : ${i.thumbnail}\n`     
...
let capt = `Ω Otakudesu Ongoing\n\n`
for (let i of res.result){
capt += `Ω Title : ${i.judul}\n`                              
capt += `Ω Thumbnail : ${i.thumb}\n`           
capt += `Ω Episode : ${i.eps}\n`     
capt += `Ω Days : ${i.hri}\n`                                
capt += `Ω Date : ${i.tgl}\n\n──────────────────────\n`
}
...
let capt = `Ω Jurnalotaku Popular Ongoing\n\n`
for (let i of res.result){
capt += `Ω Title : ${i.judul}\n`                                
capt += `Ω Url : ${i.url}\n`                                
capt += `Ω Thumbnail : ${i.img}\n\n──────────────────────\n`
}
...
let capt = `Ω Apkfap Search From ${text}\n\n`
for (let i of res.result){
capt += `Ω Title : ${i.title}\n`                              
capt += `Ω Url : ${i.url}\n`           
capt += `Ω Thumbnail : ${i.thumbnail}\n`                                   
capt += `Ω Version : ${i.version}\n\n──────────────────────\n`
}
hisoka.sendImage(m.chat, res.result[0].thumbnail, capt, m)
}
break   
...
let capt = `Ω Apkgoogle Search From ${text}\n\n`
for (let i of res.result){
capt += `Ω Title : ${i.title}\n`                              
capt += `Ω Url : ${i.url}\n`           
capt += `Ω Thumbnail : ${i.thumbnail}\n`                                   
...
let teks = `Ω Apkmody Search From ${text}\n\n`
for (let i of res.result) {
teks += `Ω Title : ${i.title}\n`                              
teks += `Ω Url : ${i.url}\n`           
teks += `Ω Version : ${i.version}\n`           
teks += `Ω Desc : ${i.description}\n\n──────────────────────\n`
}
m.reply(teks)
}
break  
...
let capt = `Ω Dlandroid Search From ${text}\n\n`
for (let i of res.result){
capt += `Ω Title : ${i.title}\n`                              
capt += `Ω Url : ${i.url}\n`           
capt += `Ω Thumbnail : ${i.thumbnail}\n` 
...
let capt = `Ω Happymod Search From ${text}\n\n`
for (let i of res.result){
capt += `Ω Title : ${i.title}\n`                              
capt += `Ω Url : ${i.url}\n`           
capt += `Ω Thumbnail : ${i.thumbnail}\n`                                        
...
let capt = `Ω Hostapk Search From ${text}\n\n`
for (let i of res.result){
capt += `Ω Title : ${i.title}\n`                              
capt += `Ω Url : ${i.url}\n`           
capt += `Ω Thumbnail : ${i.thumbnail}\n` 
...
let capt = `Ω Idlemod Search From ${text}\n\n`
for (let i of res.result){
capt += `Ω Title : ${i.title}\n`                              
capt += `Ω Develover : ${i.develover}\n`           
capt += `Ω Url : ${i.url}\n` 
capt += `Ω Thumbnail : ${i.thumbnail}\n`                   
capt += `Ω Version : ${i.version}\n`                                             
capt += `Ω Update : ${i.isUpdated}\n\n──────────────────────\n`
}
hisoka.sendImage(m.chat, res.result[0].thumbnail, capt, m)
}
break   
...
let capt = `Ω Luckymodapk Search From ${text}\n\n`
for (let i of res.result){
capt += `Ω Title : ${i.title}\n`                              
capt += `Ω Url : ${i.url}\n` 
capt += `Ω Thumbnail : ${i.thumbnail}\n`                   
...
let capt = `Ω Moddroid Search From ${text}\n\n`
for (let i of res.result){
capt += `Ω Title : ${i.title}\n`                              
capt += `Ω Url : ${i.url}\n` 
capt += `Ω Thumbnail : ${i.thumbnail}\n`                                                       
capt += `Ω Desc : ${i.version}\n\n──────────────────────\n`
}
hisoka.sendImage(m.chat, res.result[0].thumbnail, capt, m)
}
break   
...
let teks = `Ω Revdl Search From ${text}\n\n`
for (let i of res.result) {
teks += `Ω Title : ${i.title}\n`                                 
teks += `Ω Url : ${i.url}\n\n──────────────────────\n`
}
...
let capt = `Ω Toraccino Search From ${text}\n\n`
for (let i of res.result){
capt += `Ω Title : ${i.title}\n`                              
capt += `Ω Url : ${i.url}\n` 
capt += `Ω Thumbnail : ${i.thumbnail}\n`
...
let capt = `Ω Uapkpro Search From ${text}\n\n`
for (let i of res.result){
capt += `Ω Title : ${i.title}\n`                              
capt += `Ω Url : ${i.url}\n` 
capt += `Ω Thumbnail : ${i.thumbnail}\n`                                                       
...
let teks = `Ω Alkitab Search From ${text} \n\n`
for (let i of res.result) {
teks += `Ω Kitab : ${i.kitab}\n`       
teks += `Ω Url : ${i.url}\n`                                 
teks += `Ω Desc : ${i.description}\n\n──────────────────────\n`
}
m.reply(teks)
...
let teks = `Ω Al Quran Search From ${text} \n\n`
for (let i of res.result) {
teks += `Ω Kitab : ${i.urutan}\n`       
teks += `Ω Ayat : ${i.ayat}\n`           
teks += `Ω Latin : ${i.latin}\n`                                 
teks += `Ω Arti : ${i.arti}\n\n──────────────────────\n`
}
m.reply(teks)
}
...
let capt = `Ω Asmaul Husna\n\n`
for (let i of res.result){
capt += `Ω Number: ${i.index}\n`           
capt += `Ω Latin: ${i.latin}\n`      
capt += `Ω Arab: ${i.arabic}\n`      
capt += `Ω Indonesia: ${i.translation_id}\n`      
 capt += `Ω English: ${i.translation_en}\n\n──────────────────────\n`
}
m.reply(capt)
}
break
...
ΩName : ${data.result.surah}
ΩUrl : ${data.result.arab}
ΩRating : ${data.result.latin}`
m.reply(captnya)
break
//━━━━━━━━━━━━━━━[ BATAS ]━━━━━━━━━━━━━━━━━//
case 'kisahnabi': {
...
var captnya = `
ΩTitle : ${data.result.nabi}
ΩThumbnail : ${data.result.lahir}
ΩDesc : ${data.result.umur}
ΩStory : ${data.result.tempat}
ΩTitle : ${data.result.kisah}\n`
...
let capt = `Ω Amino Search From ${text}\n\n`
for (let i of res.result){
capt += `Ω Title : ${i.name}\n`                              
capt += `Ω Url : ${i.url}\n`           
capt += `Ω Thumbnail : ${i.thumbnail}\n`       
capt += `Ω Member : ${i.member}\n`              
capt += `Ω Desc : ${i.description}\n\n──────────────────────\n`
}
hisoka.sendImage(m.chat, res.result[0].thumbnail, capt, m)
}
...
let teks = `Ω Googleit Search From ${text}\n\n`
for (let i of res.result) {
teks += `Ω Title : ${i.title}\n`    
teks += `Ω Link : ${i.link}\n`                                 
teks += `Ω Snippet : ${i.snippet}\n\n──────────────────────\n`
}
m.reply(teks)
}
break  
...
let teks = `Ω Group-Whatsapp Search From ${text}\n\n`
for (let i of res.result) {
teks += `Ω Title : ${i.title}\n`                             
teks += `Ω Url : ${i.url}\n\n──────────────────────\n`
}
...
let capt = `Ω Sfile Search From ${text}\n\n`
for (let i of res.result){
capt += `Ω Title : ${i.title}\n`                              
capt += `Ω Url : ${i.link}\n` 
capt += `Ω Thumbnail : ${i.thumb}\n`                           
...
let capt = `Ω Kata Bijak Search From ${text}\n\n`
for (let i of res.result){
capt += `Ω Author : ${i.author}\n`                              
capt += `Ω Kata Bijak : ${i.katabijak}\n` 
capt += `Ω VoteCount : ${i.voteCount}\n\n──────────────────────\n`
}
m.reply(capt)
}
break   
...
var captnya = `
ΩSpek : ${data.result.spek}
ΩDisplay Type : ${data.result.display_type}
ΩDisplay Size : ${data.result.display_size}
ΩDisplay Resolusi : ${data.result.display_resolusi}
ΩChipset : ${data.result.chipset}
ΩOs : ${data.result.os}
ΩCpu : ${data.result.cpu}
ΩInternal : ${data.result.internal}
ΩCamera : ${data.result.camera}
ΩBatterai : ${data.result.Batterai}\n`
...
var captnya = `
ΩSpek : ${data.result.item}
ΩDisplay Type : ${data.result.review}
ΩDisplay Size : ${data.result.rating}
ΩDisplay Resolusi : ${data.result.price}
ΩChipset : ${data.result.score}
ΩOs : ${data.result.diskon}
ΩCpu : ${data.result.url}
ΩInternal : ${data.result.sponsor}
ΩCamera : ${data.result.best_seller}
ΩBatterai : ${data.result.amazon_prime}\n`
hisoka.sendMessage(m.chat, {caption: captnya, image: { url: data.result.thumb }}, {quoted: ftroli })
}
break
case 'thelazy': {
...
let capt = `Ω Thelazy Search From ${text}\n\n`
for (let i of res.result){
capt += `Ω Title : ${i.title}\n`                              
capt += `Ω Url : ${i.url}\n`           
capt += `Ω Thumbnail : ${i.img}\n`   
capt += `Ω Category : ${i.category}\n`           
capt += `Ω Author : ${i.author}\n`               
capt += `Ω Post Date : ${i.post_date}\n`              
capt += `Ω Comments : ${i.comments}\n\n──────────────────────\n`
}
hisoka.sendImage(m.chat, res.result[0].img, capt, m)
}
break     
...
let capt = `Ω Rexdl Search From ${text}\n\n`
for (let i of res.result){
capt += `Ω Title : ${i.title}\n`                              
capt += `Ω Url : ${i.url}\n`           
capt += `Ω Thumbnail : ${i.img}\n`       
capt += `Ω Update : ${i.update_on}\n`              
capt += `Ω Desc : ${i.desc}\n\n──────────────────────\n`
}
hisoka.sendImage(m.chat, res.result[0].img, capt, m)
}
...
caption: `
Ω Title : ${anu.results.title}
Ω Servings : ${anu.results.servings}
Ω Duration : ${anu.results.times}
Ω Dificulty : ${anu.results.dificulty}
Ω Desc : ${anu.results.desc}`,
footer: hisoka.user.name,
buttons: buttons,
headerType: 4
}
...
let capt = `Ω Drakor On Going\n\n`
for (let i of res.result){
capt += `Ω Title : ${i.title}\n`                              
capt += `Ω Url : ${i.url}\n` 
capt += `Ω Genre : ${i.genre}\n\n──────────────────────\n`
}
hisoka.sendImage(m.chat, res.result[0].img, capt, m)
}
break   
...
let capt = `Ω Jadwalbioskop Search From ${text}\n\n`
for (let i of res.result){
capt += `Ω Title : ${i.title}\n`                              
capt += `Ω Url : ${i.url}\n` 
capt += `Ω Thumbnail : ${i.img}\n\n──────────────────────\n`
...
let capt = `Ω Jadwal Otakudesu Search From ${text}\n\n`
for (let i of res.animeList){
capt += `Ω Day : ${res.day}\n`                     
capt += `Ω Title : ${i.anime_name}\n`                              
capt += `Ω Id : ${i.id}\n` 
capt += `Ω Url : ${i.link}\n\n──────────────────────\n`
}
m.reply(capt)
...
var captnya = `
ΩTitle : ${data.result.title}
ΩPengarang : ${data.result.pengarang}
ΩKategori : ${data.result.kategori}
ΩStory : ${data.result.story}\n`
m.reply(captnya)
}
break
case 'cerita-horor': {
...
let capt = `Ω Layarkaca Search From ${text}\n\n`
for (let i of res.result){
capt += `Ω Title : ${i.title}\n`                              
capt += `Ω Url : ${i.url}\n` 
capt += `Ω Thumbnail : ${i.thumbnail}\n`
capt += `Ω Author : ${i.author}\n`                               
capt += `Ω Stars : ${i.stars}\n\n──────────────────────\n`
}
hisoka.sendImage(m.chat, res.result[0].thumbnail, capt, m)
}
break   
...
let teks = `Ω Brainly Search From ${text}\n\n`
for (let i of res.result) {
teks += `Ω Source : ${i.source}\n`             
teks += `Ω Pertanyaan : ${i.pertanyaan}\n`                             
teks += `Ω Jawaban : ${i.jawaban}\n\n──────────────────────\n`
}
m.reply(teks)
}
break  
...
let capt = `Ω Antara Search From ${command}\n\n`
for (let i of res.result){
capt += `Ω News : ${i.news}\n`                              
capt += `Ω Url : ${i.url}\n` 
capt += `Ω Thumbnail : ${i.thumbnail}\n`
...
let capt = `Ω Daily Search From ${command}\n\n`
for (let i of res.result){
capt += `Ω News : ${i.news}\n`                              
capt += `Ω Url : ${i.url}\n` 
capt += `Ω Thumbnail : ${i.thumbnail}\n\n──────────────────────\n`
...
let capt = `Ω Detik Search From ${command}\n\n`
for (let i of res.result){
capt += `Ω News : ${i.news}\n`                              
capt += `Ω Url : ${i.url}\n` 
capt += `Ω Thumbnail : ${i.thumbnail}\n` 
...
let capt = `Ω Fajar Search From ${command}\n\n`
for (let i of res.result){
capt += `Ω News : ${i.news}\n`                              
capt += `Ω Url : ${i.url}\n` 
capt += `Ω Thumbnail : ${i.thumbnail}\n` 
...
let capt = `Ω Indozone Search From ${command}\n\n`
for (let i of res.result){
capt += `Ω News : ${i.news}\n`                              
capt += `Ω Url : ${i.url}\n` 
capt += `Ω Thumbnail : ${i.thumbnail}\n` 
...
ΩLogin : ${data.result.login}
ΩId : ${data.result.id}
ΩNode Id : ${data.result.node_id}
ΩAvatar : ${data.result.avatar_url}
ΩGravatar Id : ${data.result.gravatar_id}
ΩUrl : *${data.result.url}
ΩHtml : ${data.result.html_url}
ΩFollowers : ${data.result.followers_url}
ΩFollowing : ${data.result.following_url}
ΩGists : ${data.result.gists_url}
ΩStarred : ${data.result.starred_url}
ΩSubscriptions : ${data.result.subscriptions_url}
ΩOrganizations : ${data.result.organizations_url}
ΩRepos : ${data.result.repos_url}
ΩEvents : ${data.result.events_url}
ΩReceived Events : ${data.result.received_events_url}
ΩType : ${data.result.type}
ΩSite Admin : ${data.result.site_admin}
ΩName : ${data.result.name}
ΩCompany : ${data.result.company}
ΩBlog : ${data.result.blog}
ΩLocation : ${data.result.location}
ΩEmail : ${data.result.email}
ΩHireable : ${data.result.hireable}
ΩBio : ${data.result.bio}
ΩTwitter Username : ${data.result.twitter_username}
ΩPublic Repos : ${data.result.public_repos}
ΩPublic Gists : ${data.result.public_gists}
ΩCreated At : ${data.result.created_at}
ΩUpdated At : ${data.result.updated_at}\n`
m.reply(captnya)
}
break
//━━━━━━━━━━━━━━━[ OTHER ]━━━━━━━━━━━━━━━━━//
...
ΩDaerah : ${data.result.Daerah}
ΩLatitude : ${data.result.Latitude}
ΩLongitude : ${data.result.Longitude}
ΩTimeZone : ${data.result.TimeZone}
ΩTemprature : ${data.result.Temperature}
ΩTanggal : *${data.result.Tanggal}
ΩWaktu : ${data.result.Waktu}
ΩHari : *${data.result.Hari}
ΩCuaca : *${data.result.Cuaca}\n`
m.reply(captnya)
}
break
case 'infogempa': {
...
ΩWaktu : ${data.result.Waktu}
ΩLintang : ${data.result.Lintang}
ΩBujur : ${data.result.Bujur}
ΩMagnitido : ${data.result.Magnitudo}
ΩKedalaman : ${data.result.Kedalaman}
ΩWilayah : ${data.result.Wilayah}\n`
...
let capt = `Ω Informasi Loker\n\n`
for (let i of res.result){
capt += `Ω Title : ${i.title}\n`                              
capt += `Ω Url : ${i.url}\n` 
capt += `Ω Perusahaan : ${i.perusahaan}\n` 
capt += `Ω Locate : ${i.locate}\n` 
capt += `Ω Gaji : ${i.gaji}\n\n──────────────────────\n`
}
hisoka.sendImage(m.chat, res.result[0].img, capt, m)
}
...
var captnya = `
ΩUpdate : ${data.result.update}
ΩKasus : ${data.result.kasus}
ΩKematian: ${data.result.kematian}
ΩSembuh : ${data.result.sembuh}\n`
m.reply(captnya)
}
break
case 'covidworld': {
...
var captnya = `
ΩTotalCases : ${data.result.totalCases}
ΩRecovered : ${data.result.recovered}
ΩDeath: ${data.result.deaths}
ΩActiveCases : ${data.result.activeCases}
ΩClosedCases: ${data.result.closedCases}
ΩLastUpdate : ${data.result.lastUpdate}\n`
m.reply(captnya)
}
break
case 'infohoax': {
...
var captnya = `
ΩTanggal : ${data.result.tanggal}
ΩJam : ${data.result.jam}
ΩDate Time : ${data.result.datetime}
ΩCoordinates : ${data.result.coordinates}
ΩLintang : ${data.result.lintang}
ΩBujur : ${data.result.bujur}
ΩMagnitude : ${data.result.magnitude}
ΩKedalaman : ${data.result.kedalaman}
ΩWilayah : ${data.result.wilayah}
ΩPotensi : ${data.result.potensi}
ΩDirasakan : ${data.result.dirasakan}
ΩShake Map : ${data.result.shakemap}\n`
...
│ ⫹⫺ Language : Javascript
│ ⫹⫺ Author: Dika Ardnt 
│ ⫹⫺ Script : https://github.com/Anjarman200
...
urlButton: {
displayText: 'Source Code',
url: 'https://github.com/Anjarman200/'
}
}, {
callButton: {
displayText: 'Number Phone Owner',
phoneNumber: '+62 813-2849-7520'
}
}, {
quickReplyButton: {
displayText: 'Status Bot',
...
│
│Ω ${prefix}linkgroup
│Ω ${prefix}wame [number]
│Ω ${prefix}ephemeral [option]
│Ω ${prefix}setppgc [image]
│Ω ${prefix}setname [text]
│Ω ${prefix}setdesc [text]
│Ω ${prefix}group [option]
│Ω ${prefix}editinfo [option]
│Ω ${prefix}add @user
│Ω ${prefix}kick @user
│Ω ${prefix}wame [nomor]
│Ω ${prefix}hidetag [text]
│Ω ${prefix}tagall [text]
│Ω ${prefix}antilink [on/off]
│Ω ${prefix}mute [on/off]
│Ω ${prefix}promote @user
│Ω ${prefix}demote @user
│Ω ${prefix}vote [text]
│Ω ${prefix}devote
│Ω ${prefix}upvote
│Ω ${prefix}cekvote
...
│Ω ${prefix}mangadex
│Ω ${prefix}manganato
│Ω ${prefix}myanimelist
│Ω ${prefix}nekoanime
│Ω ${prefix}namigami
│Ω ${prefix}oploverz
│Ω ${prefix}samehadaku
│Ω ${prefix}otakudesu-ongoing
│Ω ${prefix}jurnalotaku-popular
│
└───────⭓
...
│
│Ω ${prefix}magma
│Ω ${prefix}hallowen-text
│Ω ${prefix}neon-light
│Ω ${prefix}broken-glass
│Ω ${prefix}art-papper
│Ω ${prefix}glossy
│Ω ${prefix}water-color
│Ω ${prefix}multi-color
│Ω ${prefix}neon-devil
│Ω ${prefix}sky-text
│Ω ${prefix}luxury
│Ω ${prefix}vintage
...
┌──⭓ *Downloader Menu*
│
│Ω ${prefix}tiktoknowm [url]
│Ω ${prefix}tiktokwm [url]
│Ω ${prefix}tiktokmp3 [url]
│Ω ${prefix}instagram [url]
│Ω ${prefix}twitter [url]
│Ω ${prefix}twittermp3 [url]
│Ω ${prefix}facebook [url]
│Ω ${prefix}pinterestdl [url]
│Ω ${prefix}ytmp3 [url]
│Ω ${prefix}ytmp4 [url]
│Ω ${prefix}getmusic [query]
│Ω ${prefix}getvideo [query]
│Ω ${prefix}umma [url]
│Ω ${prefix}joox [query]
│Ω ${prefix}jooxplay [query]
│Ω ${prefix}soundcloud [url]
│
└───────⭓
...
│Ω ${prefix}play [query]
│Ω ${prefix}yts [query]
│Ω ${prefix}google [query]
│Ω ${prefix}gimage [query]
│Ω ${prefix}pinterest [query]
│Ω ${prefix}wallpaper [query]
│Ω ${prefix}wikimedia [query]
│Ω ${prefix}ytsearch [query]
│Ω ${prefix}ringtone [query]
│Ω ${prefix}amino [query]
│Ω ${prefix}googleit [query]
│Ω ${prefix}group-whatsapp [query]
│Ω ${prefix}resepmakanan [query]
│Ω ${prefix}shopee [query]
│Ω ${prefix}arti-kata [query]
│Ω ${prefix}kata-bijak [query]
│Ω ${prefix}gsm-arena [query]
│Ω ${prefix}amazon-search [query]
│Ω ${prefix}thelazy [query]
│Ω ${prefix}rexdl-search [query]
│Ω ${prefix}sfile-search [query]
│Ω ${prefix}stalk [option] [query]
│
└───────⭓
...
│Ω ${prefix}aesthetic
│Ω ${prefix}blackpink
│Ω ${prefix}bonekachucky
│Ω ${prefix}wallpaperhacker
│Ω ${prefix}wallpaperpubg
│Ω ${prefix}wallpaperislamic
│Ω ${prefix}teknologi
│Ω ${prefix}mountain
│Ω ${prefix}cyberspace
│Ω ${prefix}programming
│Ω ${prefix}darkjoke
│Ω ${prefix}meme
│Ω ${prefix}doraemon
│Ω ${prefix}pentol
...
┌──⭓ *Text Pro Menu*
│
│Ω ${prefix}3dchristmas
│Ω ${prefix}3ddeepsea
│Ω ${prefix}americanflag
│Ω ${prefix}3dscifi
│Ω ${prefix}3drainbow
│Ω ${prefix}3dwaterpipe
│Ω ${prefix}halloweenskeleton
│Ω ${prefix}sketch
│Ω ${prefix}bluecircuit
│Ω ${prefix}space
│Ω ${prefix}metallic
│Ω ${prefix}fiction
│Ω ${prefix}greenhorror
│Ω ${prefix}transformer
│Ω ${prefix}berry
│Ω ${prefix}thunder
│Ω ${prefix}magma
│Ω ${prefix}3dcrackedstone
│Ω ${prefix}3dneonlight
│Ω ${prefix}impressiveglitch
│Ω ${prefix}naturalleaves
│Ω ${prefix}fireworksparkle
│Ω ${prefix}matrix
│Ω ${prefix}dropwater
│Ω ${prefix}harrypotter
│Ω ${prefix}foggywindow
│Ω ${prefix}neondevils
│Ω ${prefix}christmasholiday
│Ω ${prefix}3dgradient
│Ω ${prefix}blackpink
│Ω ${prefix}gluetext
│
...
│
│Ω ${prefix}1917
│Ω ${prefix}3d-crack-text-effect-online
│Ω ${prefix}3d-underwater
│Ω ${prefix}3d-wood
│Ω ${prefix}3d-wood2
│Ω ${prefix}3damerican-flag
│Ω ${prefix}3dgalaxy-metal
│Ω ${prefix}3dglue-realistic
│Ω ${prefix}3dgold
│Ω ${prefix}3dgradient
│Ω ${prefix}3dgradient2
│Ω ${prefix}3dmetal-effect
│Ω ${prefix}3dmetal-text
│Ω ${prefix}3dmulticolor-papercut
│Ω ${prefix}3dpig-gif
│Ω ${prefix}3drose-gold
│Ω ${prefix}3druby-stone
│Ω ${prefix}3dsand-engraved
│Ω ${prefix}3dshiny-metallic
│Ω ${prefix}3dsilver
│Ω ${prefix}3dspace
│Ω ${prefix}3dsparkle-christmas
│Ω ${prefix}3dsub-zombie
│Ω ${prefix}3dtext-effect
│Ω ${prefix}3dtext-effect2
│Ω ${prefix}3dtext-effect3
│Ω ${prefix}3dtext-pig
│Ω ${prefix}3dvalentine-cards
│Ω ${prefix}3dvintage-light-bulb
│Ω ${prefix}3dxmas-cards
│Ω ${prefix}3dxmas-cards2
│Ω ${prefix}83day-card
│Ω ${prefix}83day-card2
│Ω ${prefix}83day-card3
│Ω ${prefix}83day-card4
│Ω ${prefix}advanced-glow
│Ω ${prefix}ahri-league-of-legends
│Ω ${prefix}alice-league-of-kings
│Ω ${prefix}amily-arena-of-valor
│Ω ${prefix}angels-wings
│Ω ${prefix}anonymous-neon
│Ω ${prefix}art-shader
│Ω ${prefix}avengers
│Ω ${prefix}azzenka-league-of-kings
│Ω ${prefix}balloon-noel
│Ω ${prefix}balloon-text
│Ω ${prefix}balloons-cards
│Ω ${prefix}balloons-love
│Ω ${prefix}art-shader
│Ω ${prefix}bear
│Ω ${prefix}bear2
│Ω ${prefix}bee
│Ω ${prefix}birthday-cake1
│Ω ${prefix}birthday-cake2
│Ω ${prefix}birthday-cake3
│Ω ${prefix}birthday-cake4
│Ω ${prefix}birthday-cake5
│Ω ${prefix}birthday-cake6
│Ω ${prefix}birthday-cake7
│Ω ${prefix}birthday-cake8
│Ω ${prefix}birthday-cake9
│Ω ${prefix}birthday-cake10
│Ω ${prefix}birthday-cards
│Ω ${prefix}birthdayfoil-balloon
│Ω ${prefix}blackpink
│Ω ${prefix}blackpink-neon
│Ω ${prefix}blackskin-snake
│Ω ${prefix}blood-steel
│Ω ${prefix}blood-frosted
│Ω ${prefix}blood-text
│Ω ${prefix}blood-text2
│Ω ${prefix}blood-wall
│Ω ${prefix}blue-effect
│Ω ${prefix}blue-neon
│Ω ${prefix}blueglass-effect
│Ω ${prefix}bokeh-text
│Ω ${prefix}boom-comic
│Ω ${prefix}broken-glass
│Ω ${prefix}buffalo
│Ω ${prefix}bulb-effect
│Ω ${prefix}bull
│Ω ${prefix}cake-text
│Ω ${prefix}cake-text2
│Ω ${prefix}cake-text3
│Ω ${prefix}candy-text
│Ω ${prefix}captain-america
│Ω ${prefix}card-christmas
│Ω ${prefix}card-christmas2
│Ω ${prefix}cartoon-graffiti
│
└───────⭓
...
│
│Ω ${prefix}airline
│Ω ${prefix}arrow-signs
│Ω ${prefix}balloon
│Ω ${prefix}beach-sign
│Ω ${prefix}birthday-cake
│Ω ${prefix}beach-sign
│Ω ${prefix}blood_writing
│Ω ${prefix}books
│Ω ${prefix}bracelet
│Ω ${prefix}cemetery-gates
│Ω ${prefix}chalkboard
│Ω ${prefix}christmas-writing
│Ω ${prefix}cinema-ticket
│Ω ${prefix}cookies_writing
│Ω ${prefix}cross_stitch_text
│Ω ${prefix}denim-emdroidery
│Ω ${prefix}einstein
│Ω ${prefix}foggy_window_writing
│Ω ${prefix}fortune-cookie
│Ω ${prefix}frosty-window-writing
│Ω ${prefix}haunted-hotel
│Ω ${prefix}heart_tattoo
│Ω ${prefix}lifebuoy
│Ω ${prefix}light-graffiti
│Ω ${prefix}lipstick-writing
│Ω ${prefix}love-lock
│Ω ${prefix}movie_marquee
│Ω ${prefix}neon
│Ω ${prefix}neon-writing
│Ω ${prefix}nightmare-writing
│Ω ${prefix}noir
│Ω ${prefix}pendant
│Ω ${prefix}plane-banner
│Ω ${prefix}retro-wave
│Ω ${prefix}sand_writing
│Ω ${prefix}snow_writing
│Ω ${prefix}snow-sign
│Ω ${prefix}soup_letters
│Ω ${prefix}street-sign
│Ω ${prefix}surfing-board
│Ω ${prefix}tree_carving
│Ω ${prefix}typewriter
│Ω ${prefix}water-writing
│Ω ${prefix}watercolour-text
│Ω ${prefix}wooden_sign
│Ω ${prefix}yacht
│
└───────⭓
...
┌──⭓ *Move And Story*
│
│Ω ${prefix}drakorongoing
│Ω ${prefix}jadwalbioskop
│Ω ${prefix}jadwalotakudesu
│Ω ${prefix}cerpen
│Ω ${prefix}cerita-horor
│Ω ${prefix}ceritasex
│
└───────⭓
...
│Ω ${prefix}gsuggest
│Ω ${prefix}quotemaker
│Ω ${prefix}quotemaker2
│Ω ${prefix}quotemaker3
│
└───────⭓
...
│Ω ${prefix}tictactoe
│Ω ${prefix}family100
│Ω ${prefix}tebak [option]
│Ω ${prefix}math [mode]
│Ω ${prefix}suitpvp [@tag]
│
└───────⭓
...
│Ω ${prefix}artinama
│Ω ${prefix}ramaljodoh
│Ω ${prefix}ramaljodohbali
│Ω ${prefix}suamiistri
│Ω ${prefix}ramalcinta
│Ω ${prefix}cocoknama
│Ω ${prefix}pasangan
│Ω ${prefix}jadiannikah
│Ω ${prefix}sifatusaha
│Ω ${prefix}rezeki
│Ω ${prefix}pekerjaan
│Ω ${prefix}nasib
...
│Ω ${prefix}nagahari
│Ω ${prefix}arahrezeki
│Ω ${prefix}peruntungan
│Ω ${prefix}weton
│Ω ${prefix}karakter
│Ω ${prefix}keberuntungan
│Ω ${prefix}memancing
│Ω ${prefix}masasubur
│Ω ${prefix}zodiak
│Ω ${prefix}shio
...
│Ω ${prefix}bitly [url]
│Ω ${prefix}cuttly [url]
│Ω ${prefix}tinyurl [url]
│Ω ${prefix}shorturl [url]
│Ω ${prefix}translate
│
└───────⭓
...
│Ω ${prefix}ping
│Ω ${prefix}owner
│Ω ${prefix}menu / ${prefix}help / ${prefix}?
│Ω ${prefix}delete
│Ω ${prefix}infochat
│Ω ${prefix}quoted
│Ω ${prefix}listpc
...
│Ω ${prefix}kisahnabi
│Ω ${prefix}doaharian
│Ω ${prefix}tafsirsurah
│Ω ${prefix}surahpendek
│Ω ${prefix}asmaulhusna
│Ω ${prefix}alkitab-search
│
└───────⭓
...
let timb = 'https://wa.me/6281328497520'
let butts = [
...
mediaUrl: "https://github.com/Anjarman200/", 
thumbnail: fs.readFileSync('./media/kitzuna.jpg'),
sourceUrl: "https://github.com/Anjarman200"
}}
}
